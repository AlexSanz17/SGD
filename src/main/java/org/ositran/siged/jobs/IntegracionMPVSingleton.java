...
public class IntegracionMPVSingleton {
	
    private PideDAO pideDAO;
    private RecepcionPideDAO recepcionPideDAO;
    
    private static Log log=LogFactory.getLog(IntegracionMPVSingleton.class);
    ...
    public  void procesarRecepcionDespacho() {
        ...
        try{
        	log.info("..............INICIANDO PROCESO INTEGRACION MPV...............=" + new Date());        
