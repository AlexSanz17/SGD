/**
 * PcmIMgdTramiteSoap11BindingStub.java
 *
...
public class PcmIMgdTramiteSoap11BindingStub extends org.apache.axis.client.Stub implements pe.gob.segdi.wsiopidetramiteprod.ws.PcmIMgdTramitePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://ws.wsiopidetramite.segdi.gob.pe/", "CargoTramite"), pe.gob.segdi.wsiopidetramiteprod.ws.CargoTramite.class, false, false);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "request"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://ws.wsiopidetramite.segdi.gob.pe/", "ConsultaTramite"), pe.gob.segdi.wsiopidetramiteprod.ws.ConsultaTramite.class, false, false);
        oper.addParameter(param);
    ...
    public PcmIMgdTramiteSoap11BindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PcmIMgdTramiteSoap11BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PcmIMgdTramiteSoap11BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public pe.gob.segdi.wsiopidetramiteprod.ws.RespuestaCargoTramite cargoResponse(pe.gob.segdi.wsiopidetramiteprod.ws.CargoTramite request) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("cargoResponse");
        _call.setEncodingStyle(null);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {request});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (pe.gob.segdi.wsiopidetramiteprod.ws.RespuestaCargoTramite) _resp;
            } catch (java.lang.Exception _exception) {
                return (pe.gob.segdi.wsiopidetramiteprod.ws.RespuestaCargoTramite) org.apache.axis.utils.JavaUtils.convert(_resp, pe.gob.segdi.wsiopidetramiteprod.ws.RespuestaCargoTramite.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public pe.gob.segdi.wsiopidetramite.ws.RespuestaConsultaTramite consultarTramiteResponse(pe.gob.segdi.wsiopidetramite.ws.ConsultaTramite request) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("consultarTramiteResponse");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {request});
  ...
  throw axisFaultException;
    ...
    public pe.gob.segdi.wsiopidetramiteprod.ws.IoTipoDocumentoTramite[] getTipoDocumento() throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("getTipoDocumento");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (pe.gob.segdi.wsiopidetramiteprod.ws.IoTipoDocumentoTramite[]) _resp;
            } catch (java.lang.Exception _exception) {
                return (pe.gob.segdi.wsiopidetramiteprod.ws.IoTipoDocumentoTramite[]) org.apache.axis.utils.JavaUtils.convert(_resp, pe.gob.segdi.wsiopidetramiteprod.ws.IoTipoDocumentoTramite[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
    ...
    public pe.gob.segdi.wsiopidetramite.ws.RespuestaTramite recepcionarTramiteResponse(pe.gob.segdi.wsiopidetramite.ws.RecepcionTramite request) throws java.rmi.RemoteException {
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("recepcionarTramiteResponse");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
